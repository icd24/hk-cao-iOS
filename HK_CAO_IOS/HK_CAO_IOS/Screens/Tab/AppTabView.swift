            ...
            ZStack {
                ...
                VStack {
                    ...
                    ZStack(alignment: .top) {
                        Color.main.frame(height: 50 + geometry.safeAreaInsets.bottom)
                                    ...
                                    label: {
                                        ...
                                        .background(
                                            RoundedRectangle(cornerRadius: 8)
                                                .fill(self.viewModel.selectedTab == index ? .mainWhite : .transparent)
                                        )
                                    }
                                )
                    ...
                    .overlay(
                        Group {
                            if viewModel.isMasked {
                                Color.mask.edgesIgnoringSafeArea(.bottom)
                            }
                        }
                    )
                }
